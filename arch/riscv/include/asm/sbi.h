...
enum sbi_sse_event_attr {
	...
	SBI_SSE_ATTR_INTERRUPTED_A1,
	SBI_SSE_ATTR_INTERRUPTED_A2,
	SBI_SSE_ATTR_INTERRUPTED_A3,
	SBI_SSE_ATTR_INTERRUPTED_A4,
	SBI_SSE_ATTR_INTERRUPTED_A5,
...
#define SBI_SSE_ATTR_INTERRUPTED_FLAGS_PP	(1 << 0)
#define SBI_SSE_ATTR_INTERRUPTED_FLAGS_VS	(1 << 1)
