...
static void *alloc_event_data(int cpu)
{
	...
	event_data = kzalloc(sizeof(struct rvtrace_event_data), GFP_KERNEL);
	if (!event_data)
		return NULL;
...
static inline struct rvtrace_path **rvtrace_event_cpu_path_ptr(struct rvtrace_event_data *data,
							   int cpu)
{
